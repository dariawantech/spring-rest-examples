 ...
 */
package com.dariawan.rest.model;
...
public class Hello {
    ...
    /**
     * @return the helloFrom
     */
    public String getHelloFrom() {
        return helloFrom;
    }

    /**
     * @param helloFrom the helloFrom to set
     */
    public void setHelloFrom(String helloFrom) {
